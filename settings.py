...
MAP_ORDER = ["just_a_railway", "big_crossway", "prone_to_destruction", "switchers", "squares", "two_crazy_ls", "multiconcentration", "euler_squares", "familiar_friend", "three_lines", "final"]
